...
describe("getAProduct", () => {
  it("should return an array with the products", async () => {
    const received = await fn.getAProduct(1);
...
describe("getAllProductsInACategory", () => {
  it("should return products containing the category of input", async () => {
    const received = await fn.getAllProductsInACategory("men's clothing");
  ...
  it("should throw an error if url is invalid", async () => {
    ...
    try {
      await fn.getAllProductsInACategory("jewelery", invalidUrl);
    } catch (error) {
      expect(error).toBeDefined();
    }
  });
  it("should throw an error if category is invalid", async () => {
    ...
    try {
      await fn.getAllProductsInACategory(invalidCategory);
    } catch (error) {
      expect(error).toBeDefined();
    }
  });
...
describe("getAllProductsWithRateAboveFour", () => {
  it("should return an array of products with rating higher than the input", async () => {
    const minimumRate = 4;
    const received = await fn.getAllProductsWithRateAboveFour(minimumRate);
    expect(received).toEqual(
      expect.arrayContaining(
  ...
  it("should throw an error if rating is falsy", async () => {
    ...
    args.forEach((element) => {
      expect(async () => {
        await fn.getAllProductsWithRateAboveFour(element);
      }).rejects.toThrow();
    });
  });
  ...
  it("throws an error when an invalid URL is passed", async () => {
    try {
      await fn.getAllProductsWithRateAboveFour(
        4,
...
describe("getTheProductWithTheMostVotes", () => {
  it("should return the product with 679 votes", async () => {
    const received = await fn.getTheProductWithTheMostVotes();
    expect(received.rating.count).toBe(679);
  });

  it("throws an error when an invalid URL is passed", async () => {
    try {
      await fn.getTheProductWithTheMostVotes(
        "https://fakestoreapi.com/produts/"
      );
    } catch (error) {
      expect(error).toBeDefined();
...
describe("getTheAverageOfAllTheValues", () => {
  it("should return a number", async () => {
    const received = await fn.getTheAverageOfAllTheValues();
    expect(typeof received).toBe("number");
  });

  it("throws an error when an invalid URL is passed", async () => {
    try {
      await fn.getTheAverageOfAllTheValues("https://fakestoreapi.com/produts/");
    } catch (error) {
      expect(error).toBeDefined();
    }
  });
...
describe("getTheMostExpensiveProduct", () => {
  it("should return an object with price 999.99", async () => {
    const received = await fn.getTheMostExpensiveProduct();
    expect(received.price).toBeCloseTo(999.99, 3);
  });

  it("throws an error when an invalid URL is passed", async () => {
    try {
      await fn.getTheMostExpensiveProduct("https://fakestoreapi.com/produts/");
    } catch (error) {
      expect(error).toBeDefined();
    }
  });
...
describe("getTheCheapestProduct", () => {
  it("should return an object with price 7.95", async () => {
    const received = await fn.getTheCheapestProduct();
    expect(received.price).toBeCloseTo(7.95, 3);
  });

  it("throws an error when an invalid URL is passed", async () => {
    try {
      await fn.getTheCheapestProduct("https://fakestoreapi.com/produts/");
    } catch (error) {
      expect(error).toBeDefined();
    }
  });
