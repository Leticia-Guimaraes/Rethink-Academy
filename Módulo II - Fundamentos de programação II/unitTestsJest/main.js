...
module.exports.numbersArrayIntoString = (array) => {
...
module.exports.addNewLanguage = (object, newLanguage) => {
...
module.exports.votersResult = (data) =>
  data.reduce(
    (acc, cur) => {
      if (cur.age < 30) {
